...
- nav through poses, auch die orientierung muss hier erstellt werden als Teil der pose. Dazu den Winkel zum nächsten Punkt ermitteln => nicht nötig, macht der SLic3r
- zuvor den pfad erstellen mittels Slic3r